...
public class SqlQueries {
    ...
    //language=HSQLDB
    public String select01 = "SELECT ID, LASTNAME, SALARY from EMPLOYEE ORDER BY LASTNAME ASC";

    //Select employees having no more than 5 characters in last name sorted by last name in ascending order
    //language=HSQLDB
    public String select02 = "SELECT ID, LASTNAME, SALARY FROM EMPLOYEE WHERE LENGTH(LASTNAME) < 6 ORDER BY LASTNAME ASC";

    //Select employees having salary no less than 2000 and no more than 3000
    //language=HSQLDB
    public String select03 = "SELECT ID, LASTNAME, SALARY FROM EMPLOYEE WHERE SALARY >= 2000.00 AND SALARY <= 3000.00";

    //Select employees having salary no more than 2000 or no less than 3000
    //language=HSQLDB
    public String select04 = "SELECT ID, LASTNAME, SALARY FROM EMPLOYEE WHERE SALARY <= 2000.00 OR SALARY >= 3000.00";
    ...
    //language=HSQLDB
    public String select08 = "SELECT DEPARTMENT.NAME AS depname, COUNT(DEPARTMENT.NAME) AS staff_size FROM EMPLOYEE INNER JOIN DEPARTMENT on DEPARTMENT.ID = EMPLOYEE.DEPARTMENT GROUP BY DEPARTMENT.NAME";
